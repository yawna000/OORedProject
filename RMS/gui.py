...
class GUI(Database):
    def __init__(self):
        ...
        self.create_button(tab1, master, "Proceed to Menu", 1, BOTTOM, S, var1, var2, var3, None, None)
        # disables the window to be resizable
        master.resizable(False, False)
        master.mainloop()

    def create_button(self, frame, root, text, a, z, q, var1, var2, var3, name_box, cost_box):
        if name_box != "":
            if a == 1:
                ...
                ttk.Button(frame, text=text, command=lambda: [self.remove(name_box), root.destroy(),
                                                              self.open_new_window(var1, var2, var3)])\
                    .pack(side=z, anchor=q)
            elif a == 5:
    ...
    def open_new_window(self, var1, var2, var3):
        ...
        # creating buttons
        self.create_button(left_view_form1, new, "Back",  2, LEFT, W, var1, var2, var3, None, None)
        self.create_button(left_view_form1, new, "Order", 3, LEFT, W, var1, var2, var3, name_box1, cost_box1)

        self.create_button(left_view_form2, new, "Back", 2, LEFT, W, var1, var2, var3, None, None)
        self.create_button(left_view_form2, new, "Order", 3, LEFT, W, var1, var2, var3, name_box2, cost_box2)

        self.create_button(left_view_form3, new, "Back", 2, LEFT, W, var1, var2, var3, None, None)
        self.create_button(left_view_form3, new, "Order", 3, LEFT, W, var1, var2, var3, name_box3, cost_box3)

        self.create_button(left_view_form4, new, "Back", 2, LEFT, W, var1, var2, var3, None, None)
        self.create_button(left_view_form4, new, "Order", 3, LEFT, W, var1, var2, var3, name_box4, cost_box4)

        self.create_button(left_view_form5, new, "Delete", 4, LEFT, W, var1, var2, var3, id_box, None)
        self.create_button(left_view_form5, new, "Check Out", 5, LEFT, W, var1, var2, var3, id_box, None)
